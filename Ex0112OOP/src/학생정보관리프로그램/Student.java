...
public class Student {
	...
	// 라고 부는데 생략 가능하다 (디폴트 constructor)
	...
	// 필드에 있는 데이터를 객체를 생성하는 순간에 초기값를 시커줄 수있돌록 로직 작성
	...
	public void setScoreAndroid(int scoreAndroid) {
		...
		// setter 매서드 
		// set= 수정 = 클래스 내부에 있는 필드 값을 외부(다른 클래스)에서 수정하도록 하는 매서드 //외부로부터 입력받아 수정 예)메인함수로부터 받은 입력값을 적용
