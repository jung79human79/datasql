...
public class Ex01사용법 {
	...
	public static void main(String[] args) {
		...
		// jar파일->일종의 자바 프로젝트를 압축해 놓은 확장자->사용자 편하도록 개발자가 만들오 놓은 것
		// 다른사람이 개발해 놓은 class파일들이 모아저 있는 형태
		// 일종의 라이브러리
		...
		MP3Player mp3 = new MP3Player();   // 클래스이므로 역시 매서드 사용함  // play() stop() 함수사용
		...
		// 3.재생여부 판단하기
		System.out.println(mp3.isPlaying());     // false는 노래 미재생
